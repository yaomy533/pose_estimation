...
<img src=".\assert\11.png" width="960px" align="center" style="zoom:50%;" />
...
$$
\mathop {{\mathop{\rm argmin}\nolimits} }\limits_{{}_{o}^{b}T \in \{ R|t\} } \sum\limits_{i = 1}^4 {||{\mathop{\rm IoU}\nolimits} ({{\hat m}_i},K{}_{b}^iT{}_{o}^{b}TP) + L{1_{keypoint}}({{\hat k}_i},K{}_{b}^iT{}_{o}^{b}TP)||}
$$
